...
class SimpleScriptTest {
    // TODO: Test a script using the language server instead of just experimenting with the API
    @Test
    fun basicScript() {
        ...
        assertThat("Should have return value", resultValue.value, equalTo(234 + 32))
    }
