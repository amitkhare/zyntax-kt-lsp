...
class ImplementAbstractMembersQuickFixTest : SingleFileTestFixture("quickfixes", "SomeSubclass.kt") {
    @Test
    fun `handles diagnostics without a code without crashing`() {
        ...
        // A diagnostic with a null code must not crash the code action handler
        assertThat(codeActions.size, equalTo(0))
    }
